...
//        title.setBounds(PathFollowingSim.UI_WIDTH / 2 - title.getPreferredSize().width / 2, 70, title.getPreferredSize().width, title.getPreferredSize().height);
        ...
        try {
            title1 = ImageIO.read(PathFollowingSim.class.getResourceAsStream("/img/title1.png"));
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }

        try {
            title2 = ImageIO.read(PathFollowingSim.class.getResourceAsStream("/img/title2.png"));
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
